...
output += "\n        <b>";
output += runtime.suppressValue((lineno = 15, colno = 43, runtime.callWrap(runtime.memberLookup(((lineno = 15, colno = 20, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "momentjs"), "momentjs", context, [runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "post")),"timestamp")]))),"format"), "the return value of (momentjs)[\"format\"]", context, ["M/D/YY"])), env.opts.autoescape);
output += "</b><br>\n        ";
